...
namespace TheBugTracker.Data.Migrations
{
    ...
    [Migration("20221123214019_Data Models")]
            ...
            modelBuilder.Entity("TheBugTracker.Models.Ticket", b =>
                {
                    ...
                    b.Property<string>("TicketDeveloperId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TheBugTracker.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("TheBugTracker.Models.BTUser", "TicketDeveloper")
                        .WithMany()
                        .HasForeignKey("TicketDeveloperId");

                    b.HasOne("TheBugTracker.Models.BTUser", "TicketOwner")
                        .WithMany()
